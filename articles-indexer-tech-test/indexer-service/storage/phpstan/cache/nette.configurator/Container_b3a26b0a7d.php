...
class Container_b3a26b0a7d extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b3a26b0a7d $container)
			{
	...
	public function createServiceContainer(): Container_b3a26b0a7d
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'LINES' => '3000',
				'PHPRC' => 'C:\Users\jonat\AppData\Local\Temp\1EFD.tmp',
				...
				'windir' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\jonat\AppData\Local\Temp\1EFD.tmp|0|*|*|C:\xampp\php\php.ini|3.4.3',
				'ZES_ENABLE_SYSMAN' => '1',
				'_ZO_DOCTOR' => '0',
			],
		];
